...
Item {
    ...
    property alias idle_temp: idle_temp.value
    property alias flush_time: flush_time.value
    property alias ster_temp: ster_temp.value
    property alias ster_time: ster_time.value
    property alias finish_temp: finish_temp.value
	...
	Binding {
	    target: idle_temp;
	    property: "value";
	    value: idle_temp_pin.value;
	}

	Binding {
	    target: idle_temp;
	    property: "synced";
	    value: idle_temp_pin.synced;
	}
    }
	...
	Binding {
	    target: flush_time;
	    property: "value";
	    value: flush_time_pin.value;
	}

	Binding {
	    target: flush_time;
	    property: "synced";
	    value: flush_time_pin.synced;
	}
    }
	...
	Binding {
	    target: ster_temp;
	    property: "value";
	    value: ster_temp_pin.value;
	}

	Binding {
	    target: ster_temp;
	    property: "synced";
	    value: ster_temp_pin.synced;
	}
    }
	...
	Binding {
	    target: ster_time;
	    property: "value";
	    value: ster_time_pin.value;
	}

	Binding {
	    target: ster_time;
	    property: "synced";
	    value: ster_time_pin.synced;
	}
    }
	...
	Binding {
	    target: finish_temp;
	    property: "value";
	    value: finish_temp_pin.value;
	}

	Binding {
	    target: finish_temp;
	    property: "synced";
	    value: finish_temp_pin.synced;
	}
    }
